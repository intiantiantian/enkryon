...
def test_phase_6_release_uses_roadmap_version():
    ...
    assert '__version__ = "0.6.0"' in main_source
    ...
    assert (
        "Phase 6 completion therefore prepares `v0.6.0` from the "
        "official `v0.4.8` baseline."
        in normalized_guide
    )
