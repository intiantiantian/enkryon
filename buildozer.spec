...
# (str) Package name
package.name = enkryon

# (str) Package domain (needed for android/ios packaging)
package.domain = com.intian
...
source.exclude_dirs = .git,.venv,.buildozer,bin,tests,docs,__pycache__,.pytest_cache
...
presplash.filename = %(source.dir)s/assets/splash/enkryon_splash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assets/icon/enkryon.png
...
android.presplash_color = #FDF8F2
...
icon.adaptive_foreground.filename = %(source.dir)s/assets/icon/enkryon_adaptive_foreground.png
icon.adaptive_background.filename = %(source.dir)s/assets/icon/enkryon_adaptive_background.png
